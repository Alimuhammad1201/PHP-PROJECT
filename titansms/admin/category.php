                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_category.php?id=<?php echo $row['id']; ?>" class="label label-important singleDelete" onclick="return confirm('Are you pakka you want to delete this?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>

                       ...
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="../uploads/<?php echo $row['media_img']; ?>" width="80" class="img-thumbnail" alt="<?php echo $row['title']; ?>"></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="delete_media.php?id=<?php echo $row['id']; ?>" class="label label-important singleDelete" onclick="return confirm('Are you sure you want to delete this?')"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
